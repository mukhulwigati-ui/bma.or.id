            ...
            <div className="flex items-start justify-between gap-4">
              ...
              <div className="flex items-center gap-3 min-w-0">
                <div className="w-9 h-9 shrink-0 bg-white/8 border border-white/15 flex items-center justify-center">
                  <FileText className="w-4 h-4 text-[#d7b66a]" />
                </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="min-w-0 flex-1">
                ...
                <Link
                  ...
                  className="mt-3 inline-flex items-center gap-1 text-[8px] font-bold uppercase tracking-[0.14em] text-[#a37c32] hover:text-[#876725] transition"
                >
        ...
        <section className="border border-[#eadfca] bg-[#f7f2e7]/60 p-3.5">
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <Link
                href="/refund-policy"
                className="mt-1.5 inline-flex text-[8px] font-bold uppercase tracking-[0.14em] text-[#a37c32] hover:text-[#876725] transition"
              >
